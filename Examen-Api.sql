...
INSERT INTO `api_actors` (`id`, `Firstname`, `Lastname`, `age`) VALUES
	(1, 'Alejandro', 'Noris', 22),
	(2, 'Russell', 'Arcila', 24),
	(3, 'Francisco', 'Zamudio', 55);
...
INSERT INTO `api_filmdirector` (`id`, `name`, `Lastname`) VALUES
	(1, 'Cristian', 'Lopez'),
	(2, 'Ivan', 'Cabral'),
	(3, 'Bruno', 'Piña');
...
INSERT INTO `api_movie` (`id`, `name`, `description`, `ranking`, `category_id`) VALUES
	(1, 'Viernes13', 'Fea', 5, 1),
	(2, 'Pixeles', 'Graciosa', 4, 2),
	(3, 'Spiderman', 'Epica', 3, 3),
	(4, 'Cars', 'Animada', 2, 2);
...
-- Volcando estructura para tabla apidatabase.api_movie_actor
...
-- Volcando datos para la tabla apidatabase.api_movie_actor: ~0 rows (aproximadamente)
...
INSERT INTO `auth_permission` (`id`, `name`, `content_type_id`, `codename`) VALUES
	...
	(37, 'Can add film director', 10, 'add_filmdirector'),
	(38, 'Can change film director', 10, 'change_filmdirector'),
	(39, 'Can delete film director', 10, 'delete_filmdirector'),
	(40, 'Can view film director', 10, 'view_filmdirector'),
	(41, 'Can add actors', 11, 'add_actors'),
	(42, 'Can change actors', 11, 'change_actors'),
	(43, 'Can delete actors', 11, 'delete_actors'),
	(44, 'Can view actors', 11, 'view_actors');
...
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	...
	(24, 'api', '0002_actors_filmdirector_movie_actor_movie_director', '2022-02-23 23:01:13.702027');
